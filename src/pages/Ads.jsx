          ...
          <div className="w-full max-w-4xl bg-white shadow-md rounded-lg p-4 mb-6">
            ...
            <div className="w-full border border-gray-200 rounded-lg p-4 bg-white h-[540px] md:h-[410px] overflow-y-auto">
              {copyRoomData.map((ad, index) => (
                <div
                  key={index}
                  className="flex flex-col md:flex-row w-full mx-auto bg-white shadow-md rounded-lg overflow-hidden md:h-48 mb-4 border border-gray-200 hover:shadow-lg transition-shadow duration-200"
                >
                  ...
                  <div className="w-full md:w-2/3 p-4 flex flex-col justify-between">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start gap-2">
                      <div className="w-4/6">
                        <h3 className="text-lg font-semibold text-blue-800 overflow-hidden text-ellipsis whitespace-nowrap">
                          {ad.name}
                        </h3>
                    ...
                    <div className="flex gap-3 justify-end mt-2">
                      ...
                      >
                        <FiInfo
                          size={20}
                          className="inline-flex align-middle text-blue-600"
                        />
                        <span className="inline-flex align-middle font-medium">
                          {adsPage.details}
                        </span>
                      </button>
                      ...
                      >
                        <LuMessageCircleMore
                          size={20}
                          className="inline-flex align-middle text-green-600"
                        />
                        <span className="inline-flex align-middle font-medium">
                          {adsPage.message}
                        </span>
                      ...
                      >
                        <FaHeart
                          size={20}
                          className="inline-flex align-middle text-red-500"
                        />
                        <span className="inline-flex align-middle font-medium">
                          {adsPage.favorite}
                        </span>
                      ...
                      >
                        <FaShareAlt
                          size={20}
                          className="inline-flex align-middle text-indigo-500"
                        />
                        <span className="inline-flex align-middle font-medium">
